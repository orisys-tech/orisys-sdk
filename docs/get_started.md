...
例如 `orisys-<版本>-cp310-cp310-win_amd64.whl` 表示：

版本：`<版本>`（以实际下载的文件名为准，可用 `python -c "import orisys; print(orisys.__version__)"` 确认）
...
```bash
# 请将文件名替换为您实际下载的文件名
pip install orisys-<版本>-cp310-cp310-win_amd64.whl
```
